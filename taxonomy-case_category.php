...
$term_name = $terms && !is_wp_error($terms) && !empty($terms) ? esc_html($terms[0]->name) : '';
?>
...
<head>
  ...
  <title><?php echo $term_name; ?>｜導入事例｜株式会社ランドコンピュータ</title>
    ...
    <div class="breadcrumb">
      <div class="inner breadcrumb__inner">
        <ul class="breadcrumb__list flex">
          ...
          <li class="breadcrumb__item"><?= $term_name ?></li>
        </ul>
      </div>
    </div>
